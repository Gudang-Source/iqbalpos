...
<div class="row" style='min-height:80px;'>
  ...
  <div class="row">
    <h3><strong>Master</strong> - Supplier Bahan</h3>
  </div>
           ...
           <div class="row">
             ...
             <div class="col-sm-6">
               <div class="form-group">
                 ...
                 <input type="number" min="0" maxlength="50" name="no_telp" class="form-control" id="no_telp" placeholder="No Telp Supplier Bahan" required="">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
