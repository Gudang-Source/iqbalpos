...
class Master extends MX_Controller {
    ...
    function index(){
    	...
    	$data['list'] = json_encode($this->Metodepembayaranmodel->select($dataSelect, 'm_metode_pembayaran')->result());
		//echo $data;
		//print_r($data);
    	$this->load->view('Metode_pembayaran/view', $data);
    }
	
	function test(){
		header('Content-Type: application/json; charset=utf-8');
		$dataSelect['deleted'] = 1;
		$list = $this->Metodepembayaranmodel->select($dataSelect, 'm_metode_pembayaran')->result();
