 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Metode Pembayaran</h4>
      </div>
           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 ...
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Metode Pembayaran">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Metode Pembayaran">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  function showAdd(){
    $("#myModalLabel").text("Tambah Metode Pembayaran");
    $("#id").val("");
    $("#nama").val("");
  ...
  function showUpdate(i){
    $("#myModalLabel").text("Ubah Metode Pembayaran");
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Metode_pembayaran/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Metode_pembayaran/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Metode_pembayaran/Master/delete'); ?>/',
