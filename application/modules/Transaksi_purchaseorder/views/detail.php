...
<script type="text/javascript" language="javascript" >  
    ...
    var dataTables = $('#TableMains').DataTable( {
        ...
        "ajax":{
            ...
            dataType : "json",
            error: function(){
                $("#TableMains").append('<tbody class="employee-grid-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
    ...
    function confirm(id){
      ...
      $.ajax({
        url :"<?php echo base_url('Transaksi_purchaseorder/Transaksi/confirm')?>/"+id,
        type : "POST",
