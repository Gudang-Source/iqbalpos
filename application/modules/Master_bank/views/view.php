...
<div class="row" style='min-height:80px;'>
  ...
  <div class="row">
    <h3><strong>Master</strong> - Bank</h3>
  </div>
           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 ...
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Bank">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Bank">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Master_bank/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Master_bank/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Master_bank/Master/delete'); ?>/',
