  ...
  <div id='notif-top' style="margin-top:50px;display:none;" class="col-md-4 alert alert-success pull-right">
   ...
   <div class="row" style="margin-top:10px;">
      <table id="TableMain" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
              <tr>
                  <th class="text-center">Nama Warna Bahan</th>
 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Warna Bahan</h4>
      </div>
           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 <label for="nama">Nama Warna Bahan</label>
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Warna Bahan">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Warna Bahan">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  function showAdd(){
    $("#myModalLabel").text("Tambah Warna Bahan");
    $("#id").val("");
    $("#nama").val("");
  ...
  function showUpdate(i){
    $("#myModalLabel").text("Ubah Warna Bahan");
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Bahan_baku_warna/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Bahan_baku_warna/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Bahan_baku_warna/Master/delete'); ?>/',
