...
class Master extends MX_Controller {
    ...
    function add(){
		...
		$checkData = $this->Bahanwarnamodel->select($dataInsert, 'm_bahan_warna');
	...
	function get($id = null){   	
    	if($id != null){
    		$dataSelect['id'] = $id;
    		$selectData = $this->Bahanwarnamodel->select($dataSelect, 'm_bahan_warna');
    ...
    function edit(){
		...
		$checkData = $this->Bahanwarnamodel->select($dataCondition, 'm_bahan_warna');
