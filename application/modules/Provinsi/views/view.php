           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 ...
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Provinsi">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Provinsi">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  function showAdd(){
    $("#myModalLabel").text("Tambah Provinsi");
    $("#id").val("");
    $("#nama").val("");
  ...
  function showUpdate(i){
    $("#myModalLabel").text("Ubah Provinsi");
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Provinsi/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Provinsi/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Provinsi/Master/delete'); ?>/',
