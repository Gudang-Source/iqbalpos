           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 ...
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Kategori Produk">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Kategori Produk">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  function showAdd(){
    $("#myModalLabel").text("Tambah Kategori Produk");
    $("#id").val("");
    $("#nama").val("");
  ...
  function showUpdate(i){
    $("#myModalLabel").text("Ubah Kategori Produk");
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Produk_kategori/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Produk_kategori/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Produk_kategori/Master/delete'); ?>/',
