...
class Master extends MX_Controller {
    ...
    function index(){
        ...
        $data['list_prov'] = json_encode($this->Gudangmodel->select($dataSelect, 'm_provinsi')->result());
        $data['list_kota'] = json_encode($this->Gudangmodel->select($dataSelect, 'm_kota')->result());
		...
		//echo $data;
		//print_r($data);
    	$this->load->view('Gudang/view', $data);
    }
    ...
    function get_kota(){
    	...
    	$dataSelect['deleted'] = 1;
    	echo json_encode($this->Gudangmodel->select($dataSelect, 'm_kota')->result());
    }
