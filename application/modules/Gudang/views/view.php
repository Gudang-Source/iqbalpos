           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 ...
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Gudang">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Gudang">
               </div>
             </div>
             <div class="col-sm-12">
               <div class="form-group">
                 <label for="alamat">Alamat Gudang</label>
                 <input type="text" name="alamat" maxlength="30" class="form-control" id="alamat" placeholder="Alamat Gudang" required="">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
...
<script type="text/javascript">
  ...
  function get_kota(){
  	...
  	$.ajax({
  	   url :"<?php echo base_url('Gudang/Master/get_kota')?>/",
  	   type : "GET",
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Gudang/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Gudang/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Gudang/Master/delete'); ?>/',
