...
<body>
	<div id="page-wrap">
		...
		<hr class="stripe">
		<h5 class="text-center"><b>FAKTUR RETUR</b></h5>
		...
		<table id="items">
		  ...
		  foreach ($data->result_array() as $row) { 
			  ...
			  <tr class="item-row">
			      ...
			      <td class>
			      	<?php echo !empty($row['nama_warna']) ? $row['nama_warna'] : 'Tidak ada';?>
		      	</td>
	      ...
	      <td colspan="4" class="blank text-left">Terima kasih sudah berbelanja</td>
